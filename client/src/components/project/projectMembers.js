...
const ProjectMember = ({auth,auth:{user},getProject,getMembers, removeMember,loading,profile: {profiles},getProfiles,project:{project, members}, match}) => {
...
const filteredMembers = ''
    ...
    return  members === null || user === null ? <Spinner/> : <Fragment>
       {/* <p>{project.name}</p> */}
      ...
      <p className="lead">
        ...
        <div style={{overflowY : 'auto',height: '41rem', paddingRight: '10px'}}>
...
export default connect(mapStateToProps, {getCurrentProfile,getMembers,removeMember,getProfiles,getProject}) (ProjectMember)
